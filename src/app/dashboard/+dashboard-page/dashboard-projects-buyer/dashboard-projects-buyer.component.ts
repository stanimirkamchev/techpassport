...
import { createFeedbackLoop } from '../../../feedback/store';

@Component({
  selector: 'dashboard-projects-buyer',
  templateUrl: './dashboard-projects-buyer.component.html',
  styleUrls: ['./dashboard-projects-buyer.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DashboardProjectsBuyerComponent extends Destroyable implements OnInit {
